...
import TotalAssetsSection from "@/components/section/total-assets";
import TransactionTable from "@/components/section/transaction-table";
      ...
      <div className=" bg-white">
        ...
        <div className="relative w-full h-[350px] rounded-lg overflow-hidden">
          ...
          <div
            ...
            style={{
              backgroundImage: "url('/assets.jpg')",
            }}
          ></div>
